...
def read_creds(credsfile = None):
    """ Read in the config file and return its data as a dictionary.
      ...
      :param credsfile: The path to an ldap configuration file
      :type credsfile: string
      :returns: dict with keys(): ('LDAP_USERNAME',
        'LDAP_PASSWORD','LDAP_SERVER', 'LDAP_BASE', 'LDAP_DOMAIN')
